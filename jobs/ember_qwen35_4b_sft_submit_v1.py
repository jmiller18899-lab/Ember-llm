...
from ember_qwen35_4b_sft_v1 import REPO
...
def main():
    ...
    guard = "launches/qwen35-4b-sft-v1.json"
    ...
    source = Path("jobs/ember_qwen35_4b_sft_v1.py").read_bytes()
    ...
    try:
        job = api.run_uv_job("jobs/ember_qwen35_4b_sft_v1.py", python="3.11", flavor="l4x1", timeout=7200,
            name="ember-qwen35-4b-sft-v1", secrets={"HF_TOKEN":os.environ["HF_TOKEN"]},
