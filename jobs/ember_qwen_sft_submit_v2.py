...
from ember_qwen_sft_v2 import REPO
...
def main():
    ...
    try:
        job = api.run_uv_job("jobs/ember_qwen_sft_v2.py", python="3.11", flavor="l4x1", timeout=7200,
            name="ember-qwen35-2b-sft-v2", secrets={"HF_TOKEN":os.environ["HF_TOKEN"]},
