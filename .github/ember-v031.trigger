mode: bootstrap
purpose: disarm Ember v0.0.31 after corrected CPU preflight submission; no paid GPU training
...
max_steps: 600
next_action: observe corrected CPU preflight only; require explicit approval before any T4 launch
