mode: bootstrap
purpose: keep Ember v0.0.31 disarmed after successful CPU preflight; prevent paid GPU launch without explicit approval
...
previous_preflight_job: Jmiller18899/6a9f8b4d259f8e97255eddba (failed before training on resolver version string; fixed)
...
max_steps: 600
next_action: v0.0.31 T4 is evidence-supported; require explicit approval before one paid T4 launch
