...
one_variable: where the copy target sits in the completion
...
next_action: run mode "audit" (free), then "preflight" (CPU) and read EMBER_V033_TRAIN_ENCODING and EMBER_V033_BASELINE_SLOT_EXACT before considering "train"
