mode: train
purpose: launch exactly one Ember v0.0.28 T4 boundary-focus run after successful CPU decision preflight
...
max_steps: 600
next_action: submit one approved v0.0.28 T4 session, then disarm immediately after job id is confirmed
