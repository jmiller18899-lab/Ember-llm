mode: preflight
purpose: run Ember v0.0.29 CPU preflight only; do not launch paid GPU training
...
next_action: CPU preflight only; read EMBER_V029_GATE_DISTANCE and band histogram before any T4 decision
