mode: preflight
purpose: run Ember v0.0.26 CPU preflight on Claude branch using repository H_F2 secret; no paid GPU training
...
next_action: record the 90-case CPU preflight baseline; do not launch T4 training from this trigger
